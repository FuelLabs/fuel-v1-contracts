  ...
  object "Runtime" {
    code {
      ...
      case sig"transact(address destination, uint256 value, bytes data)" {
        ...
        require(gte(calldatasize(), 100), error"calldata-size-underflow")
        ...
        require(call(gas(), mload(0), mload(32), mload(64), mload(96), 0, 0),
          error"call")
      }
      ...
      // Invalid signature
      default { require(0, error"invalid-signature") }
